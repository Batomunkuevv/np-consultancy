...
const initAnimations = () => {
    ...
    function animateWantUse() {
        ...
        tl
            .from(wantUseTitle, { opacity: 0, duration: 1 })
            .from(wantUseText, { opacity: 0, duration: 1 })
            .from(wantUseButton, { opacity: 0, duration: 1 })
    }
    ...
    function animateHasRequest() {
        ...
        tl
            .from(hasRequestImage, { opacity: 0, duration: 1 })
            .from(hasRequestTitle, { opacity: 0, duration: 1 }, '<')
            .from(hasRequestText, { opacity: 0, duration: 1 })
            .from(hasRequestButton, { opacity: 0, duration: 1 })
    }
}
